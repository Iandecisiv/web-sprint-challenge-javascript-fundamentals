...
lowPopulationAnimals = zooAnimals.filter(animal => {return animal.population < 5});
...
let populationArray = zooAnimals.map(animal => animal.population);

populationTotal = populationArray.reduce(reducer);
